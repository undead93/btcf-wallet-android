...
import com.bitcoinfinal.core.coins.AsiacoinMain;
...
import com.bitcoinfinal.core.coins.CanadaeCoinMain;
import com.bitcoinfinal.core.coins.CannacoinMain;
import com.bitcoinfinal.core.coins.ClamsMain;
import com.bitcoinfinal.core.coins.ClubcoinMain;
import com.bitcoinfinal.core.coins.CoinID;
import com.bitcoinfinal.core.coins.CoinType;
import com.bitcoinfinal.core.coins.DashMain;
import com.bitcoinfinal.core.coins.DigibyteMain;
...
import com.bitcoinfinal.core.coins.EguldenMain;
import com.bitcoinfinal.core.coins.FeathercoinMain;
import com.bitcoinfinal.core.coins.GcrMain;
import com.bitcoinfinal.core.coins.GuldenMain;
import com.bitcoinfinal.core.coins.JumbucksMain;
import com.bitcoinfinal.core.coins.KH69CoinMain;
import com.bitcoinfinal.core.coins.KhcoinMain;
import com.bitcoinfinal.core.coins.LitecoinMain;
import com.bitcoinfinal.core.coins.LitecoinTest;
import com.bitcoinfinal.core.coins.MonacoinMain;
import com.bitcoinfinal.core.coins.NamecoinMain;
import com.bitcoinfinal.core.coins.NeoscoinMain;
import com.bitcoinfinal.core.coins.NovacoinMain;
import com.bitcoinfinal.core.coins.NuBitsMain;
import com.bitcoinfinal.core.coins.NuSharesMain;
import com.bitcoinfinal.core.coins.NxtMain;
import com.bitcoinfinal.core.coins.OKCashMain;
import com.bitcoinfinal.core.coins.ParkbyteMain;
import com.bitcoinfinal.core.coins.PeercoinMain;
import com.bitcoinfinal.core.coins.PopularcoinMain;
import com.bitcoinfinal.core.coins.PotcoinMain;
import com.bitcoinfinal.core.coins.ReddcoinMain;
import com.bitcoinfinal.core.coins.RubycoinMain;
import com.bitcoinfinal.core.coins.ShadowCashMain;
import com.bitcoinfinal.core.coins.UroMain;
import com.bitcoinfinal.core.coins.VergeMain;
import com.bitcoinfinal.core.coins.VertcoinMain;
import com.bitcoinfinal.core.coins.VpncoinMain;
import com.bitcoinfinal.core.coins.RichcoinMain;
import com.bitcoinfinal.core.coins.IxcoinMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/inmean/bitcoinfinal-android/releases";

    public static final String VERSION_URL = "https://bitcoinfinalproject.com/version";
    public static final String SUPPORT_EMAIL = "support@bitcoinfinalproject.com";
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(KhcoinMain.get(),       new ServerAddress("electrum.bitcoinfinalproject.com", 50001),
                                                    new ServerAddress("electrum.bitcoinfinal.inmean.com", 50001)),
            new CoinAddress(KH69CoinMain.get(),     new ServerAddress("128.199.215.245", 50001)),
            new CoinAddress(PopularcoinMain.get(),  new ServerAddress("188.166.218.82", 50001)),
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.LITECOIN_MAIN.getCoinType(), "https://chain.so/tx/LTC/%s");
